...
function chgPackage(value) {
    ...
    for (let i = 1; i <= pins / 2; i++) {
        ...
        labels.innerHTML += `<input type="text" class="pin_label" size="10" name="pin${i}" placeholder="Pin ${i}">`;
        labels.innerHTML += `<input type="text" class="pin_label" size="10" name="pin${pins+1-i}" placeholder="Pin ${pins+1-i}">`;
